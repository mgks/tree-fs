...
### 7. Rich Text & Emojis
We automatically clean up "decorative" trees often generated by newer AI models (like Claude or GPT-4o).

**It handles:**
*   **Leading Emojis:** `📁 src`, `🚀 start.js`, `⚛️ components` are cleaned.
*   **Parenthetical Explanations:** `index.js (The Entry Point)` is cleaned.
...
**Note:** Parentheses are only stripped if they are at the end of the line and preceded by a space. Filenames like image(1).png or data_2024(final).csv are preserved safely.
